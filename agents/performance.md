...
Specialized agent to improve performance.
...
## Measurement First (REQUIRED)

- Do not optimize blindly.
- Add measurement before/after:
  - Web Vitals (LCP/CLS/INP)
  - Angular DevTools profiling (when applicable)
  - Network waterfall for large assets

## Performance Budgets (Recommended)

- Keep routes lean: avoid loading heavy components above the fold.
- Prefer lazy routes and `@defer` for below-the-fold UI.
- Avoid large third-party dependencies unless justified.

## Runtime Rules

- Avoid expensive work in template expressions.
- Prefer `computed()` for derived values.
- Avoid unnecessary reflows/repaints by measuring layout repeatedly.

## Performance Review Checklist

- Is this on the critical rendering path?
- Can it be deferred, lazy-loaded, or split?
- Is there a measurable before/after improvement?
- Does this optimization increase complexity disproportionately?
